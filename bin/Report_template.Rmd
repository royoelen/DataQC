...
cov <- fread("CovariatePCs.txt", keepLeadingZeros = TRUE)
```
...
![(#fig:fig5)**Fig 5. Genotype samples projected into 1000G superpopulations.** First two plots show only target dataset in the 1000G PC space. Rest of the plots visualise target dataset, as well as samples from 1000G superpopulations by plotting first 10 genotype PCs.](outputfolder_gen/gen_plots/SamplesPCsProjectedTo1000G.png)  
