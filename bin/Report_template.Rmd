...
```{r, fig.height = 3.5, fig.width = 7, fig.align = "center", message = FALSE, eval = (nr_add_cov == 2 | nr_add_cov == 4 | nr_add_cov == 5 | nr_add_cov == 6), warning = FALSE, echo = FALSE}
ggplot(cov_specific, aes(x = value)) + geom_histogram(colour = "white") + facet_wrap(~ covariate, scales = "free", ncol = 3) + theme_bw() + xlab("Covariate value")
```

```{r, fig.height = 15, fig.width = 7, fig.align = "center", message = FALSE, eval = (nr_add_cov > 9), warning = FALSE, echo = FALSE}
ggplot(cov_specific, aes(x = value)) + geom_histogram(colour = "white") + facet_wrap(~ covariate, scales = "free", ncol = 3) + theme_bw() + xlab("Covariate value")
```
