...
wgs_table <- fread("wgs_qc_table_combined.txt", header=T, data.table=F)
#wgs_settings <- fread("wgs_qc_settings_combined.txt", header=T, data.table=F)
overview_table <- fread("outputfolder_gen/gen_data_summary/summary_table.txt", data.table=F)
